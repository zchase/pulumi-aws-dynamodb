...
namespace Pulumi.AwsDynamoDB
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.AwsDynamoDB.version.txt");
    ...
    internal sealed class AwsDynamoDBResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public AwsDynamoDBResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
